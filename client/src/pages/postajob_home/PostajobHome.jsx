...
import AuthModal from "../BrowseJobs/components/AuthModal";
function PostajobHome() {
					...
					<div className="job-container">
						<div className="card-workers">
							...
							<div className="workers-writeup" id="workers-writeup">
								<h4>
									Creedlance Work-Force (
									<b className="bold_recommended_gold">Recommended</b>){" "}
								</h4>
								<p>
					...
					<div className="job-container">
						<div className="card-workers">
							...
							<div className="workers-writeup" id="workers-writeup">
								<h4>
									interview a worker (
									<b className="bold_recommended_gold">New!</b>){" "}
								</h4>
								<p>
									This option allows you to post an interview, by setting the
									date and time of the mentioned interview also the description
									and other formalities, when your interview is posted you will
									receive different applications including cv from
									workers(creedlancers), in your category of work..
								</p>
					...
					<div className="job-container">
						<div className="card-workers">
							...
							<div className="workers-writeup">
								<h4>
									Award your project to Our trustworthy workers (
									<b className="bold_recommended_gold">Premium!</b>)
								</h4>
								<p>
								...
								<a href="/trustworthy_worker_form1">
