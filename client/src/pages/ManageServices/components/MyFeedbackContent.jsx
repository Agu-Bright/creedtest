...
import FeedbackContentBody from "./FeedbackContentBody";
export default function MyFeedbackContent(props) {
  ...
  useEffect(() => {
    ...
    const getMyReviews = async () => {
      setLoading(true);
      const res = await fetchData("/services/get-all-my-services?reviews=true");
      setreviews(res.allReviews.reverse());
      setLoading(false);
    };
    getMyReviews();
  }, []);
          ...
          <div className="body02">
            {reviews && !reviews.length && !loading && (
              <div className="body02-container">
                ...
                <p>
                  There are no Feedback yet. Ask your customers leave feedback
                  about you. Copy the link and send them
                </p>
