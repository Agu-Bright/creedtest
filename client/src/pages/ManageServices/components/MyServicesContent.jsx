...
export default function MyServicesContent(props) {
  ...
  const fetchMyServices = async () => {
    setLoading(true);
    await fetchData("/services/get-all-my-services")
      .then((res) => {
        setServices(res.services.reverse());
        setActive(res.services.length);
        setLoading(false);
      })
      .catch((e) => {
  ...
  const handleDelete = async (id) => {
    // /:id/delete-a-service
    await deleteData(`/services/${id}/delete-a-service`)
      .then((res) => {
        setShowDeleteModal(false);
        setServices((prev) => prev.filter((items) => items._id !== id));
        setState((prev) => !prev);
      ...
      <div className="section-manage-services-container">
        ...
        >
              ...
              {props.h3.toLowerCase() !== "performance" ? (
                <ul className="general-content-header">
                  <li className="active-list-item">
                    {props.active} {props.received} ({active})
                  </li>
          ...
          <div className="body02">
            {services && !services.length && !loading && (
              <div className="body02-container">
                <img src={props.img} alt="" />
                <p>
                  No Services has been created, Click on the button to create.
                </p>
