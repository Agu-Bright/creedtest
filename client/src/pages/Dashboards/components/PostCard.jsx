...
const PostCard = ({ hideNavBar, showNavBar, description, files, post, id }) => {
  ...
  useEffect(() => {
    socket &&
      socket.on("new social post like", (data) => {
        setLikes(data.length);
      });
    socket &&
      socket.on("new dislike social post", (data) => {
        setDislikeCount(data.length);
      });
    socket &&
    ...
    !deleted && (
      <>
        ...
        >
          ...
          {!isCommentLoading && (
            <div className="post__card" style={{marginBottom:'10px'}}>
              {/* header */}
              <div className="card__header">
                <img
                  ...
                  src={post?.createdBy?.photo?.url || avatarImage}
                  alt=""
                />
                <div className="middle">
                  <div className="top">
                    <Link
                      ...
                      to={"/profile/" + post?.createdBy?.username + "/posts"}
                    >
              ...
              <div className="card__footer">
                ...
                <div className="top">
                  ...
                  >
                    {post?.comments?.length || commentLength} Comments
                  </p>
                </div>
