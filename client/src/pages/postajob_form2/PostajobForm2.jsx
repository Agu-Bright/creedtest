      ...
      <section className="section-formpost">
        ...
        <div className="formpost-container">
          <div className="formpost-heading">
            <h4>Step 2</h4>
            <p>You are one step away from getting bids from workers and
              Enterprises
          ...
          <form action="#" className="form">
            <div className="form-container">
              ...
              <div className="project">
                ...
                <h5>What type of project are you posting</h5>


                <div className="job-section-one">
                  <select name="budget" id="budget">
                    <option value="budget">Public-Bidding </option>
                    <option value="budget">Private-Biding</option>
                  </select>
                </div>
                ...
                <div className="project-type">
                  <div className="standard-project">
                    ...
                    <div className="project-writeup">
                      <h5> Public-Biding</h5>
                      <p>
                        A public Bid project will allow, creedlancers to see
                        each others bid and proposals, which may encourage
                        competition and lower prices
                      </p>
                    </div>
                  </div>
                  <div className="standard-project">
                    <img src={recruiterProject} alt="private-Biding" />
                    <div className="project-writeup">
                      <h5>Private-Biding</h5>
                      <p>
          ...
          <a href="/postedsuccessfully" className="btn-approve">
            Yes, post my project.
          </a>
        </div>
      </section>
