...
export const Filter = ({hideFilter, allPosts}) => {
    ...
    if(allPosts?.length > 2) {
      if (window.innerWidth >= 769){
        if (document.querySelector("html").scrollTop >= 444){
          ...
          filterRef.current.style.overflow = window.innerHeight >= 940 ? "hidden" : "auto"
          filterRef.current.style.height = "100vh"
          filterRef.current.style.width = "270px"
          filterRef.current.style.maxHeight = "900px"
